...
function getUrl($path = '', $params = []) {
    ...
    if (empty($path)) {
        ...
        // Assets, controllers, admin, uploads - direct path
        return $base . '/' . $path;
...
function app_log(string $message, string $type = 'INFO', array $context = []): void {
    // Always log to file using SimpleLogger if available
...
function log_activity($message, $context = []) {
    ...
    try {
        ...
        $activity_type = 'testimonial_submission';
