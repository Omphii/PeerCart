...
try {
    ...
    // Get recent messages for both sellers and buyers
...
if ($userType === 'seller') {
    $recentListings = $db->prepare("
        SELECT id, name, price, status, created_at, image
        FROM listings
    ...
    // Variables already initialized with defaults
}
    ...
    <aside class="dashboard-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <!-- In dashboard.php sidebar navigation -->
<li>
    <a href="<?= BASE_URL ?>/pages/manage-listings.php">
        ...
        <!-- In sidebar-footer section, fix the logout button -->
    ...
    <main class="dashboard-main">
        ...
        <div class="content-grid">
            ...
            <div class="content-left">
                <!-- Recent Activity -->
                <!-- Replace the entire Recent Listings section with this: -->
<div class="content-card">
    <div class="card-header">
        <h3>
            <i class="fas fa-list"></i> Recent Listings
        </h3>
        <a href="<?= BASE_URL ?>/pages/manage-listings.php" class="view-all">Manage All</a>
    </div>
    <div class="card-body">
        <?php 
        // Debug: Check what we have
        // echo "<!-- Debug: userType = $userType, recentListings count = " . count($recentListings) . " -->";
        
        if ($userType === 'seller' && !empty($recentListings)): 
        ?>
            <div class="listings-list">
                ...
                <div class="listing-item">
                    ...
                    <div class="listing-info">
                        <h4><?= htmlspecialchars(substr($listing['name'], 0, 30)) ?></h4>
        ...
        <?php elseif ($userType === 'seller'): ?>
            <div class="empty-state">
                ...
                <p>No listings found. Start selling!</p>
                <a href="<?= BASE_URL ?>/pages/sell.php" class="btn btn-primary">Create Listing</a>
            </div>
        <?php elseif ($userType === 'buyer' && !empty($recommendedListings)): ?>
            <!-- Buyer recommendations code -->
        <?php endif; ?>
    </div>
</div>
