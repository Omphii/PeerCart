        ...
        <div class="footer-container">
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="<?= BASE_URL ?>/pages/listings.php">Shop</a></li>
                        <li><a href="<?= BASE_URL ?>/pages/sell.php">Sell</a></li>
                        <li><a href="<?= BASE_URL ?>/pages/auth.php">About Us</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    <h4>Support</h4>
                    <ul class="footer-links">
                        <li><a href="<?= BASE_URL ?>/pages/support.php">FAQ</a></li>
                        <li><a href="<?= BASE_URL ?>/pages/support.php">Contact</a></li>
                        <li><a href="<?= BASE_URL ?>/pages/support.php">Shipping</a></li>
                        <li><a href="<?= BASE_URL ?>/pages/support.php">Returns</a></li>
                    </ul>
                </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-legal">
                    ...
                    <a href="<?= BASE_URL ?>/pages/cookies.php">Cookies</a>
                </div>
            </div>
        </div>
    </footer>
